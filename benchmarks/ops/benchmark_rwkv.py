...
@triton.testing.perf_report(
    triton.testing.Benchmark(
        ...
        line_arg='provider',
        line_vals=['rwkv7', 'rwkv7_bwd', 'rwkv6',  'rwkv6_bwd','flash', 'flash_bwd' ],
        # label name for the lines
        line_names=['rwkv7', 'rwkv7_bwd', 'rwkv6', 'rwkv6_bwd','flash','flash_bwd'],
...
def benchmark(T, provider):
    ...
    if provider == 'rwkv6':
        ...
        results = triton.testing.do_bench(lambda: chunk_rwkv7(q, w, k, v, a, b, head_first=False)[0].backward(do), quantiles=quantiles)
